...
arquivo = open("Teste3-Sim2/log.txt",'w')
arquivo.close()

#Usando o teste de arquitetura qtdd
for j in range(0, 10):

    regr = MLPRegressor(hidden_layer_sizes=(3000, 700), 
                        max_iter=1000,
    ...
    arquivo = open("Teste3-Sim2/log.txt",'a')
    ...
    plt.savefig("Teste3-Sim2/teste"+str(j+1)+".png", format='png')
    arquivo.close()