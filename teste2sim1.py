...
#Usando o teste de arquitetura Quantidade
for j in range(0, 10):

    regr = MLPRegressor(hidden_layer_sizes=(10000),  
                        max_iter=100000,
    ...
    arquivo = open("Teste2-Sim1/log.txt",'a')
    ...
    plt.savefig("Teste2-Sim1/teste"+str(j+1)+".png", format='png')
    arquivo.close()