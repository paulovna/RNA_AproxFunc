...
arquivo = open("Teste3-Sim1/log.txt",'w')
arquivo.close()

#Usando o teste de arquitetura iterações
for j in range(0, 10):

    regr = MLPRegressor(hidden_layer_sizes=(1500,1500),  # Quantidade de neuronios
    ...
    arquivo = open("Teste3-Sim1/log.txt",'a')
    ...
    plt.savefig("Teste3-Sim1/teste"+str(j+1)+".png", format='png')
    arquivo.close()
